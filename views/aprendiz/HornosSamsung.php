...
<Center>
   ...
   <table border="2">
    <tr>
        <th scope="colgroup" colspan="4"><h3><font color="Orange"><center>HORNOS MICROONDAS SAMSUNG</center></font></h3></th>
    </tr>
    <tr>
        <td scope="rowgroup"> <img  src="views/aprendiz/38.jpg" width="100" height="100"></td>
        <td scope="col"><h4><font color="white"><p>Hornos microondas, </p><p>de conveccion</p><p>de 32 L</p></font></h4></td>
        <td scope="col"><h4><font color="white">$880.000</font></h4></td>  
    </tr>
    <tr>
         
    </tr>
    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/39.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Hornos microondas</p><p>de conveccion </p><p>de 28 L</p></font></hz></td>
        <td scope="col"><h4><font color="white">$1.383.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/40.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Horno microondas  </p><p>Con Grill </p><p>de 20 L</p></font></hz></td>
        <td scope="col"><h4><font color="white">$1.200.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/41.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Horno microondas  </p><p>con grill</p><p>de 23 L</p></font></hz></td>
        <td scope="col"><h4><font color="white">$1.400.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/42.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Horno microondas  </p><p>con grill</p><p>de 28 L</p></font></hz></td>
