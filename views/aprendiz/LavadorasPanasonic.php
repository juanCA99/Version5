...
<Center>
   ...
   <table border="2">
    <tr>
        <th scope="colgroup" colspan="4"><h3><font color="Orange"><center>LAVADORAS PANASONIC</center></font></h3></th>
    </tr>
    <tr>
        <td scope="rowgroup"> <div id="containerEx3"> <div class="ex3"> 
        <img alt="img0" src="views/aprendiz/54.jpg" width="100" height="100"></div></div></td>
        <td scope="col"><h4><font color="white"><p>Nevera </p><p>NA-14OXR1</p></font></h4></td>
        <td scope="col"><h4><font color="white">$1.180.000</font></h4></td>  
    </tr>
    <tr>
         
    </tr>
    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/55.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p> Nevera </p><p>NA-128VB6WES </p></font></hz></td>
        <td scope="col"><h4><font color="white">$1.130.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/56.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Nevera  </p><p>NA-127VB6WES </p></font></hz></td>
        <td scope="col"><h4><font color="white">$1.000.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/57.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Nevera   </p><P>NA-127VC6WES</P></font></hz></td>
        <td scope="col"><h4><font color="white">$990.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/58.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Nevera  </p><P>NA-148XR1WES</P></font></hz></td>
        <td scope="col"><h4><font color="white">$1.150.000</font></hz></td>   
    </tr>
