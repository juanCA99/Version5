...
<Center>
   ...
   <table border="2">
    <tr>
        <th scope="colgroup" colspan="4"><h3><font color="Orange"><center>NEVERAS PANASONIC</center></font></h3></th>
    </tr>
    <tr>
        <td scope="rowgroup"> <img  src="views/aprendiz/49.jpg" width="100" height="100"></td>
        <td scope="col"><h4><font color="white"><p>Nevera </p><p>NR-BN34EX2</p></font></h4></td>
        <td scope="col"><h4><font color="white">$1.480.000</font></h4></td>  
    </tr>
    <tr>
         
    </tr>
    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/50.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p> Nevera </p><p>NR-BN34EW2 </p></font></hz></td>
        <td scope="col"><h4><font color="white">$1.230.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/51.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Nevera  </p><p>NR-B53V2 </p></font></hz></td>
        <td scope="col"><h4><font color="white">$1.000.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/52.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Nevera   </p><P>NR-B53VW2-WE</P></font></hz></td>
        <td scope="col"><h4><font color="white">$890.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/53.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Nevera  </p><P>NR-BN34AW1</P></font></hz></td>
        <td scope="col"><h4><font color="white">$1.350.000</font></hz></td>   
    </tr>
