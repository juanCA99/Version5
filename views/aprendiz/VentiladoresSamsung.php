...
<Center>
   ...
   <table border="2">
    <tr>
        <th scope="colgroup" colspan="4"><h3><font color="Orange"><center>VENTILADORES SAMSUNG</center></font></h3></th>
    </tr>
    <tr>
        <td scope="rowgroup"> <img  src="views/aprendiz/43.jpg" width="100" height="100"></td>
        <td scope="col"><h4><font color="white"><p>Ventilador de mesa, </p><p>de 12"</p></font></h4></td>
        <td scope="col"><h4><font color="white">$480.000</font></h4></td>  
    </tr>
    <tr>
         
    </tr>
    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/44.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p> Ventilador </p><p>Aiprotec </p><p>az 2 en 1</p></font></hz></td>
        <td scope="col"><h4><font color="white">$883.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/45.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Ventilador  </p><p>Ciclonic </p></font></hz></td>
        <td scope="col"><h4><font color="white">$900.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/46.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Ventilador orbital  </p></font></hz></td>
        <td scope="col"><h4><font color="white">$600.000</font></hz></td>   
    </tr>

    <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/47.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Ventilador simple  </p></font></hz></td>
        <td scope="col"><h4><font color="white">$700.000</font></hz></td>   
    </tr>
     <tr>
    	<td scope="rowgroup"><img src="views/aprendiz/48.jpg" width="100" height="100"></td>
    	<td scope="col"><h4><font color="white"><p>Ventilador de mesa  </p></font></hz></td>
