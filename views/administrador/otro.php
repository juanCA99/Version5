...
<center><h1><font color="white">ELIMINAR</font></h1></center>
<br>
<br>
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-danger">
				<div class="panel-heading"> <center> ELIMINAR </center>
				</div>
				<div class="panel-body">
					<form method="post" action="?controller=Administrador&accion=Eliminar">
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
							<input type="text" name="id" class="form-control" placeholder="ingrese aqui el id a eliminar">
						</div>
						<hr>
